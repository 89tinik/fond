 ...
 */
class m241203_155740_insert_data_field_table_for_event extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $contestId = (new \yii\db\Query())
            ->select('id')
            ->from('{{%contests}}')
            ->where(['name' => 'Мероприятия'])
            ->scalar();

        if (!$contestId) {
            echo "Конкурс 'Мероприятия' не найден.\n";
            return;
        }
        ...
        $fieldsData = [
            ...
            $sections[2] => [
                ...
                ['name' => 'UF_CRM_DEAL_1691563538364', 'label' => 'Тип мероприятия (селект)', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690807980716', 'label' => 'Краткая аннотация проекта (до 5 предложений)', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690976749478', 'label' => 'Сроки проведения мероприятия (день, месяц, год)', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690976766958', 'label' => 'Площадка проведения мероприятия', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690811478973', 'label' => 'Ожидаемое количество участников (с указанием страны, чел.)', 'type' => 'text'],
            ...
            $sections[3] => [
                ...
                ['name' => 'UF_CRM_1702905041', 'label' => 'Расчётый счёт', 'type' => 'text', 'b24entity' => 'company'],
            ...
            $sections[5] => [
                ...
                ['name' => 'UF_CRM_DEAL_1690976821714', 'label' => 'Даты проведения мероприятия', 'type' => 'text'],
                ...
                ['name' => 'UF_CRM_DEAL_1690811478973', 'label' => 'Ожидаемые результаты проекта (мультиполе)', 'type' => 'text', 'multi' => 1],
                ['name' => 'UF_CRM_DEAL_1690976915577', 'label' => 'Общее количество участников', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690976940886', 'label' => 'Количество выступающих с докладами (с указанием подтвердившихся)', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690976970568', 'label' => 'Ожидаемое количество иностранных / иногородних участников (с указанием региона страны)', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690976988469', 'label' => 'Ожидаемое кол-во молодых участников', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690971632575', 'label' => 'Иные ожидаемые результаты (количественные)', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690971653285', 'label' => 'Ожидаемый медиа-эффект', 'type' => 'text'],
            ...
            $sections[6] => [
                ['name' => 'UF_CRM_DEAL_1691729934958', 'label' => 'Свидетельство о государственной регистрации (ОГРН)', 'type' => 'file'],
                ['name' => 'UF_CRM_DEAL_1691729955790', 'label' => 'Свидетельство о постановке на налоговый учет(ИНН)', 'type' => 'file'],
                ['name' => 'UF_CRM_DEAL_1691729975175', 'label' => 'Устав ,а также все действующие изменения и дополнения к нему', 'type' => 'file'],
                ['name' => 'UF_CRM_DEAL_1691729999544', 'label' => 'Документ, подтверждающий полномочия лица на осуществление действий от имени ЮЛ', 'type' => 'file'],
                ['name' => 'UF_CRM_DEAL_1691730092064', 'label' => 'Описание проекта', 'type' => 'file'],
                ['name' => 'UF_CRM_DEAL_1691730136621', 'label' => 'Смета (заполненная и заверенная)', 'type' => 'file'],
                ['name' => 'UF_CRM_DEAL_1691730185761', 'label' => 'Опыт в реализации проектов подобного рода(предметные результаты деятельности)', 'type' => 'file'],
                ['name' => 'UF_CRM_DEAL_1691730205652', 'label' => 'Рекомендация', 'type' => 'file'],
                ['name' => 'UF_CRM_DEAL_1691730232885', 'label' => 'Дополнительные материалы', 'type' => 'file'],
                ['name' => 'UF_CRM_DEAL_1691730271713', 'label' => 'Гарантийное письмо', 'type' => 'file'],
            ],
        ];
