 ...
 */
class m241203_155737_insert_data_field_table_for_show extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $fieldsData = [
            ...
            $sections[2] => [
                ...
                ['name' => 'UF_CRM_DEAL_1690959509092', 'label' => 'Дата открытия выставки', 'type' => 'date'],
                ['name' => 'UF_CRM_DEAL_1690959528132', 'label' => 'Дата завершения выставки', 'type' => 'date'],
                ['name' => 'UF_CRM_DEAL_1690976766958', 'label' => 'Площадка проведения выставки (мультиполе)', 'type' => 'text', 'multi' => 1],
                ['name' => 'UF_CRM_DEAL_1690959635542', 'label' => 'Каталог выставки (указать тираж, если планируется издание)', 'type' => 'text'],
            ],
            $sections[3] => [
            ...
            $sections[5] => [
                ...
                ['name' => 'UF_CRM_DEAL_1690971574261', 'label' => 'Ожидаемое количество посетителей', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690971601771', 'label' => 'Приблизительное количество экспонатов', 'type' => 'text'],
                ['name' => 'UF_CRM_DEAL_1690971632575', 'label' => 'Иные ожидаемые результаты', 'type' => 'text'],
            ...
            $sections[6] => [
                ...
                ['name' => 'UF_CRM_DEAL_1691730807790', 'label' => 'Научная концепция выставочного проекта в свободной форме', 'type' => 'file', 'multi' => 1],
                ['name' => 'UF_CRM_DEAL_1691732119927', 'label' => 'Тематико-экспозиционный план выставочного проекта в свободной форме', 'type' => 'file', 'multi' => 1],
            ]
        ];
